    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col selection:bg-zinc-800 selection:text-white">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 pt-16 sm:pt-24 pb-16 text-center space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <Link
            href="/orcamento"
            className="w-full sm:w-auto px-5 py-2.5 bg-zinc-100 hover:bg-white text-zinc-950 font-semibold text-xs rounded-md border border-zinc-200 transition-colors flex items-center justify-center gap-2 shadow-sm"
          >
          ...
          <Link
            href="/consultas"
            className="w-full sm:w-auto px-4 py-2.5 rounded-md border border-zinc-800 bg-zinc-900/60 hover:bg-zinc-800 text-zinc-300 font-medium text-xs transition-colors flex items-center justify-center gap-2"
          >
        ...
        <div className="max-w-4xl mx-auto pt-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-zinc-900/40 border border-zinc-800 rounded-lg p-3 sm:p-4 text-left font-mono">
      ...
      <section className="py-16 max-w-5xl mx-auto px-4 sm:px-6 space-y-8">
        ...
        <div className="bg-zinc-950 border border-zinc-800 rounded-lg overflow-hidden text-xs">
      ...
      <section id="precos" className="py-16 max-w-6xl mx-auto px-4 sm:px-6 space-y-10 border-t border-zinc-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Free Plan */}
          <div className="bg-zinc-900/40 border border-zinc-800 rounded-lg p-6 flex flex-col justify-between space-y-6">
            ...
            <Link
              ...
              className="w-full py-2 px-3 rounded-md bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 text-zinc-200 text-xs font-semibold text-center transition-colors"
            >
              Criar Conta Grátis
            </Link>
          </div>
          ...
          {/* Pro Plan */}
          <div className="bg-zinc-900/70 border-2 border-zinc-600 rounded-lg p-6 flex flex-col justify-between space-y-6 relative">
            <div className="space-y-3">
              <div className="flex justify-between items-start">
                ...
                <span className="px-1.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase bg-emerald-950 text-emerald-400 border border-emerald-800/60">
                  Mais Usado
                </span>
              </div>
            ...
            <Link
              href="/login?mode=signup"
              className="w-full py-2 px-3 rounded-md bg-zinc-100 hover:bg-white text-zinc-950 text-xs font-semibold text-center transition-colors shadow-sm"
            >
              Assinar Plano Pro
            </Link>
          </div>
